        ...
        <div class="w-full md:w-1/2 lg:w-2/5 flex flex-col">
            ...
            <form action="{{ route('cart.add', $product) }}" method="POST" class="mt-auto">
                ...
                <div class="flex space-x-4 mb-6">
                    ...
                    <button type="submit" class="w-2/3 h-14 flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-medium tracking-wide uppercase transition-all duration-300 shadow-md hover:shadow-xl disabled:bg-zinc-300 disabled:cursor-not-allowed" {{ $product->stock == 0 ? 'disabled' : '' }}>
